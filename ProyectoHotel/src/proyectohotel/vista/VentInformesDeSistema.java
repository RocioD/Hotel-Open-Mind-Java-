...
public class VentInformesDeSistema extends JFrame implements ActionListener {
    ...
    public void initComponentes() {
        ...
        promTodashabitaciones = new JRadioButton("Promedio de pasajeros por habitación");
        ...
        panel.add(textRut);
        textRut.setBounds(500, 120, 150, 25);
        panel.add(rutclient);
        ...
        if (e.getSource() == buscar) {
            ...
            if (buscarCliente.isSelected()) {
                if (controlador.verificarRut(rutclient.getText())) {
                    ...
                    String registros = "\nRegistros: \n" + controlador.informeGastosPorRut(rutBuscar);
